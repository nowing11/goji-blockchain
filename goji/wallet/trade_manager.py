...
from goji.types.coin_solution import CoinSolution
...
# from goji.wallet.cc_wallet.debug_spend_bundle import debug_spend_bundle
        ...
        if goji_discrepancy is not None:
            ...
            if goji_spend_bundle is not None:
                for coinsol in coinsols:
                    goji_spend_bundle.coin_solutions.append(coinsol)
