...
from goji.plotting.create_plots import create_plots
from goji.consensus.block_creation import create_unfinished_block, unfinished_block_to_full_block
...
from goji.plotting.plot_tools import PlotInfo, load_plots, parse_plot_info
...
from goji.util.wallet_tools import WalletTool
...
class BlockTools:
    ...
    def init_plots(self, root_path: Path):
        ...
        try:
            ...
            args.pool_contract_address = encode_puzzle_hash(self.pool_ph, "xgj")
