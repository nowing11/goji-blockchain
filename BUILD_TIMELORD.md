...
required to run a [Timelord](https://github.com/Goji-Network/goji-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Goji-Network/goji-blockchain/blob/main/install-timelord.sh)
