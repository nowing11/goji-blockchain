...
required to run a [Timelord](https://github.com/GetGoji/goji-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/GetGoji/goji-blockchain/blob/main/install-timelord.sh)
